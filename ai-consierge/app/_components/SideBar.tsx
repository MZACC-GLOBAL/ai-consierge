...
import { BarChart3, Code, CreditCard, Hotel, LogOut, MessagesSquare, Settings, Shield, Sparkles, Target, TrendingUp, X } from 'lucide-react';
...
const SideBar = () => {
  ...
  return (
    <aside className="bg-[#004E7C] w-86  h-screen  border-r border-[#003D5F] flex flex-col shadow-lg displayNoneRes">
        {/* header */}
